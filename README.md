...
| `www.reddit.com` | known-site metadata; authorization required for declared download path | read-only: navigate-to-author, navigate-to-category, navigate-to-content, navigate-to-utility-page, query-account-profile, query-social-content, query-social-relations, search-content, switch-in-page-state; requires: pypy3 | requires: pypy3; reason: robots-restricted-and-auth-required; dependency reason: runtime-dependency-missing |
