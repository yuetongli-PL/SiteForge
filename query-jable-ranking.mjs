...
import { normalizeUrlNoFragment } from './lib/normalize.mjs';
...
export async function queryJableRanking(url, options = {}) {
  ...
  const entrypointPath = path.resolve(runtimeOptions.workspaceRoot, 'query-jable-ranking.mjs');
...
function printHelp() {
  process.stdout.write([
    'Usage:',
    '  node query-jable-ranking.mjs <url> --query "<natural language>"',
    '  node query-jable-ranking.mjs <url> --target-label "<label>" --sort combined --limit 3',
    '',
    'Options:',
