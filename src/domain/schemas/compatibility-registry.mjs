...
} from '../capabilities/focused-regression-batches.mjs';
import {
...
} from '../policies/download-policy.mjs';
import {
...
} from '../risks/risk-state.mjs';
import {
  SESSION_VIEW_SCHEMA_VERSION,
  assertSessionViewCompatible,
} from '../sessions/session-view.mjs';
import {
...
} from '../policies/standard-task-list.mjs';
...
const COMPATIBILITY_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    ...
    assertCompatible: assertSiteCapabilityGraphCompatible,
  }),
  Object.freeze({
    name: 'GraphManifest',
    version: GRAPH_MANIFEST_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphManifestCompatible,
  }),
  Object.freeze({
    name: 'GraphNode',
    version: GRAPH_NODE_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphNodeCompatible,
  }),
  ...
  Object.freeze({
    ...
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphEdgeCompatible,
  }),
  Object.freeze({
    name: 'GraphValidationReport',
    version: GRAPH_VALIDATION_REPORT_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphValidationReportCompatible,
  }),
  Object.freeze({
    name: 'GraphQueryResult',
    version: GRAPH_QUERY_RESULT_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphQueryResultCompatible,
  }),
  Object.freeze({
    name: 'LayerSourceRiskPolicyInventorySummary',
    version: GRAPH_QUERY_RESULT_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertLayerSourceRiskPolicyInventorySummaryCompatibility,
  }),
  Object.freeze({
    name: 'LayerSourceAuthSessionRequirementInventorySummary',
    version: GRAPH_QUERY_RESULT_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertLayerSourceAuthSessionRequirementInventorySummaryCompatibility,
  }),
  Object.freeze({
    name: 'LayerSourceSignerDependencyInventorySummary',
    version: GRAPH_QUERY_RESULT_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertLayerSourceSignerDependencyInventorySummaryCompatibility,
  }),
  Object.freeze({
    name: 'GraphDocsSummary',
    version: GRAPH_DOCS_SUMMARY_SCHEMA_VERSION,
    sourcePath: 'src/domain/capabilities/site-capability-graph.mjs',
    assertCompatible: assertGraphDocsSummaryCompatible,
  }),
  Object.freeze({
    name: 'SessionView',
