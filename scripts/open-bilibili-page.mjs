...
const DEFAULT_OPTIONS = {
  outDir: path.join(REPO_ROOT, 'archive', 'bilibili-open'),
  profilePath: null,
...
const HELP = `Usage:
  node scripts/open-bilibili-page.mjs <url> [--profile-path <path>] [--browser-path <path>] [--browser-profile-root <dir>] [--user-data-dir <dir>] [--out-dir <dir>] [--timeout <ms>] [--reuse-login-state|--no-reuse-login-state] [--auto-login-bootstrap|--no-auto-login-bootstrap]
