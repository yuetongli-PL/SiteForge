...
import { bilibiliAdapter } from '../core/adapters/bilibili.mjs';
import { apiCandidateFromObservedRequest } from '../capability/api-discovery.mjs';
import {
  writeVerifiedApiCatalogArtifactsFromObservedProducerEvidence,
} from '../capability/api-catalog-promotion.mjs';
import {
  createExecutableCapabilityEvidenceFixture,
} from '../capability/capability-evidence-chain.mjs';
import {
  createSiteOnboardingDiscoveryArtifacts,
  createSiteOnboardingDiscoveryInputFromCaptureExpand,
} from '../capability/site-onboarding-discovery.mjs';
import {
