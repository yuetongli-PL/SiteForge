...
const INTENT_FAMILY_CANDIDATES = Object.freeze({
  ...
  'list-bookmarks': ['query-social-content'],
  'list-direct-messages': ['query-private-messages'],
  'list-explore-topics': ['query-social-content'],
  'list-followed-updates': ['query-social-content'],
  'list-followed-users': ['query-social-relations'],
  'list-hot-broadcasts': ['query-media-content', 'query-social-content'],
  'list-inbox-messages': ['query-private-messages'],
  'list-lists': ['query-social-relations'],
  ...
  'list-hot-posts': ['query-social-content', 'navigate-to-category'],
  ...
  'list-topic-discussions': ['query-social-content', 'navigate-to-category'],
  'list-topic-featured': ['query-social-content', 'navigate-to-category'],
  'list-user-activities': ['query-account-profile', 'query-social-content'],
  'list-user-answers': ['query-account-profile', 'query-social-content'],
  'list-user-articles': ['query-account-profile', 'query-social-content'],
  'list-user-collections': ['query-account-profile', 'query-social-content'],
  'list-user-columns': ['query-account-profile', 'query-social-content'],
  'list-user-following': ['query-account-profile', 'query-social-relations'],
  'list-user-pins': ['query-account-profile', 'query-social-content'],
  'list-user-questions': ['query-account-profile', 'query-social-content'],
  'list-user-videos': ['query-account-profile', 'query-media-content', 'query-social-content'],
  ...
  'open-search-result-detail': ['search-content', 'navigate-to-content'],
  ...
  'read-search-result-summaries': ['search-content', 'query-social-content'],
  ...
  'search-latest-posts': ['search-content', 'query-social-content'],
  'search-media-posts': ['search-content', 'query-social-content'],
  'search-note': ['search-content'],
  'search-posts': ['search-content', 'query-social-content'],
  'search-users': ['search-content', 'query-account-profile'],
  'search-video': ['search-content'],
  'search-work': ['search-content'],
  'view-answer-detail': ['navigate-to-content', 'query-comment-thread'],
  'view-question-detail': ['navigate-to-content', 'query-comment-thread'],
});
