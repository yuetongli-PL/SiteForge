...
function createSyntheticGraphNodePayload(type) {
  ...
  const byType = {
    ...
    ExecutionContractNode: {
      siteKey: 'synthetic.example',
      capabilityRef: 'capability:synthetic.example:read-public-page',
      operationKind: 'read-public-page',
      requestSchemaRef: 'schema:synthetic-request',
      responseSchemaRef: 'schema:synthetic-response',
      runtimeBindingRef: 'runtime-binding:synthetic.example:read-public-page',
      sessionRequirementRef: 'session:synthetic.example:none',
      authRequirementRef: 'auth:synthetic.example:none',
      riskPolicyRef: 'risk-policy:synthetic.example:normal',
      governancePolicyRef: 'governance-policy:synthetic.example:read-public-page',
      ...
      sourceRefs: ['config/site-capabilities.json'],
      testEvidenceRefs: ['tests/node/compatibility-registry.test.mjs'],
    },
    RuntimeBindingNode: {
      siteKey: 'synthetic.example',
      bindingKind: 'descriptor-only',
      allowedMaterial: ['public-page-descriptor'],
      forbiddenMaterial: ['cookie', 'token'],
      redactionRequired: true,
      credentialMaterialPolicy: 'forbidden',
      sourceRefs: ['config/site-capabilities.json'],
    },
    GovernancePolicyNode: {
      ...
      sitePolicyExplicitAllowRequired: false,
      runtimeConstraintRequired: false,
      naturalLanguageRequestGrantsExecution: false,
      runtimeDispatchAllowedByDefault: false,
      reasonCodeRefs: ['synthetic-public-read-allowed'],
      sourceRefs: ['config/site-capabilities.json'],
    },
    SchemaNode: {
