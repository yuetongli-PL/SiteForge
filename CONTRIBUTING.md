...
Redaction. Compile artifact writes now also include a redacted
...
evidence fixtures, and a Layer-owned runtime receipt consumer.
...
- Current status: `verified`
- Existing code evidence: `src/sites/capability/reason-codes.mjs` defines the governed catalog and health/download/API/onboarding reason families, including `blocked-by-cloudflare-challenge` for public request challenge stop boundaries, `jable-native-resolver-required` for the Jable experimental download placeholder, and `expand-navigation-failed` / `expand-stage-failed` for capture-preserving partial preview recovery after expand-stage failure.
...
- Last updated: 2026-05-10T22:57:04+08:00
...
- Next smallest task: Add additional site-specific verified SiteAdapter/schema/test/policy evidence for executable capability readiness.
...
- Last updated: 2026-05-10T23:06:44+08:00
