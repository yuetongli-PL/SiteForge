...
import { normalizeReasonCode } from '../risks/reason-codes.mjs';
import {
...
const LIFECYCLE_EVENT_PRODUCER_DESCRIPTORS = Object.freeze([
  ...
  },
  {
    ...
    sourceModule: 'src/domain/policies/execution/layer-runtime-consumer.mjs',
    profileStatus: 'profiled',
  },
  {
    eventType: 'session.run.completed',
    producerId: 'session-runner.completed',
    sourceModule: 'src/domain/sessions/runner.mjs',
    profileStatus: 'inventoried',
  },
  {
    eventType: 'site.health.recovery.evaluated',
    producerId: 'site-health-recovery.evaluated',
    sourceModule: 'src/domain/risks/site-health-execution-gate.mjs',
    profileStatus: 'profiled',
  },
  {
  ...
  },
  {
    ...
    sourceModule: 'src/sites/known-sites/social/actions/router.mjs',
    profileStatus: 'profiled',
  },
