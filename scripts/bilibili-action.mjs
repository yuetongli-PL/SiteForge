...
import { runBilibiliAction } from '../lib/bilibili-action-router.mjs';

const MODULE_DIR = path.dirname(fileURLToPath(import.meta.url));
const REPO_ROOT = path.resolve(MODULE_DIR, '..');

const HELP = `Usage:
  node scripts/bilibili-action.mjs open <url> [--profile-path <path>] [--browser-path <path>] [--browser-profile-root <dir>] [--reuse-login-state|--no-reuse-login-state] [--auto-login-bootstrap|--no-auto-login-bootstrap]
  node scripts/bilibili-action.mjs download <url-or-bv>... [--out-dir <dir>] [--concurrency <n>] [--max-playlist-items <n>] [--reuse-login-state|--no-reuse-login-state] [--auto-login-bootstrap|--no-auto-login-bootstrap] [--skip-existing] [--retry-failed-only] [--resume|--no-resume] [--dry-run]
  node scripts/bilibili-action.mjs login [<url>] [--profile-path <path>] [--browser-path <path>] [--browser-profile-root <dir>] [--reuse-login-state|--no-reuse-login-state]
  node scripts/bilibili-action.mjs preflight <url> [--profile-path <path>] [--browser-path <path>] [--browser-profile-root <dir>] [--reuse-login-state|--no-reuse-login-state]
`;
