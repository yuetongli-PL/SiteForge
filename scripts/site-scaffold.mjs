...
import { sanitizeHost, uniqueSortedStrings } from '../lib/normalize.mjs';
import { PROFILE_ARCHETYPES, resolveProfilePrimaryArchetype } from '../lib/sites/archetypes.mjs';
import { validateProfileObject } from '../lib/profile-validation.mjs';

const MODULE_DIR = path.dirname(fileURLToPath(import.meta.url));
const REPO_ROOT = path.resolve(MODULE_DIR, '..');
const DEFAULT_OPTIONS = {
  archetype: null,
  outDir: path.join(REPO_ROOT, 'archive', 'site-scaffold'),
...
const HELP = `Usage:
  node scripts/site-scaffold.mjs <url> --archetype <navigation-catalog|chapter-content> [--profiles-dir <dir>] [--profile-path <path>] [--out-dir <dir>] [--timeout <ms>]
`;
