...
import { initializeCliUtf8 } from '../src/infra/cli.mjs';
import { openBrowserSession } from '../src/infra/browser/session.mjs';
import { capture } from '../src/entrypoints/pipeline/capture.mjs';
import { expandStates } from '../src/entrypoints/pipeline/expand-states.mjs';
import {
...
import { inspectLoginState, resolveSiteAuthProfile, resolveSiteBrowserSessionOptions } from '../src/infra/auth/site-auth.mjs';
