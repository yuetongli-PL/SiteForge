...
import { ARTIFACT_REFERENCE_SET_SCHEMA_VERSION } from '../artifacts/schema.mjs';
import {
...
import { NETWORK_CAPTURE_REQUEST_SCHEMA_VERSION } from '../artifacts/network-capture.mjs';
...
import { SITE_HEALTH_EXECUTION_GATE_SCHEMA_VERSION } from '../risks/site-health-execution-gate.mjs';
import { SITE_HEALTH_RECOVERY_SCHEMA_VERSION } from '../risks/site-health-recovery.mjs';
...
export const CAPABILITY_SERVICE_MODULE_PREFIX = 'src/domain/';
...
const NETWORK_CAPTURE_MODULE = 'src/domain/artifacts/network-capture.mjs';
const API_DISCOVERY_MODULE = 'src/domain/capabilities/api-discovery.mjs';
const API_CANDIDATES_MODULE = 'src/domain/capabilities/api-candidates.mjs';
const SESSION_VIEW_MODULE = 'src/domain/sessions/session-view.mjs';
const RISK_STATE_MODULE = 'src/domain/risks/risk-state.mjs';
const SECURITY_GUARD_MODULE = 'src/domain/sessions/security-guard.mjs';
const ARTIFACT_SCHEMA_MODULE = 'src/domain/artifacts/schema.mjs';
const STANDARD_TASK_LIST_MODULE = 'src/domain/policies/standard-task-list.mjs';
const DOWNLOAD_POLICY_MODULE = 'src/domain/policies/download-policy.mjs';
const LIFECYCLE_EVENTS_MODULE = 'src/domain/lifecycle/lifecycle-events.mjs';
const CAPABILITY_HOOK_MODULE = 'src/domain/lifecycle/capability-hook.mjs';
const SITE_ONBOARDING_DISCOVERY_MODULE = 'src/domain/capabilities/site-onboarding-discovery.mjs';
const SITE_HEALTH_RECOVERY_MODULE = 'src/domain/risks/site-health-recovery.mjs';
const SITE_HEALTH_EXECUTION_GATE_MODULE = 'src/domain/risks/site-health-execution-gate.mjs';
